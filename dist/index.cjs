 ...
 * @type {Uint8Array[]}
 */
const KNOWN_IMAGE_MAGIC_NUMBER = [new Uint8Array([0xff, 0xd8, 0xff]),
// JPEG
...
// ICO
new Uint8Array([0x42, 0x50, 0x47, 0xfb]),
// BPG
new Uint8Array([0x46, 0x4f, 0x52, 0x4d]),
// HEIF
